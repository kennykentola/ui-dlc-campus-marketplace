    ...
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center space-y-8 animate-bounceIn">
          <div className="w-24 h-24 bg-brand-surface text-brand-primary rounded-full flex items-center justify-center mx-auto shadow-sm">
            <i className="fa-solid fa-check-double text-4xl"></i>
          </div>
          <div className="space-y-4">
            <h1 className="text-3xl font-black text-brand-primary uppercase tracking-tighter">Case Logged.</h1>
          ...
          <button onClick={() => navigate("/")} className="w-full py-5 bg-brand-primary text-white rounded-3xl font-black uppercase tracking-widest hover:brightness-110 active:scale-95 transition-all">Return to Terminal</button>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-transparent min-h-screen pt-32 pb-40 px-6">
      <main className="max-w-2xl mx-auto space-y-16 animate-slideUp">
        <header className="text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-brand-primary uppercase tracking-tighter leading-none">Safe Trade <span className="text-brand-primary">Hub.</span></h1>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-50 border border-slate-100 rounded-[56px] p-8 md:p-14 space-y-10 shadow-2xl shadow-brand-primary/5 relative overflow-hidden">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-brand-primary/40 uppercase tracking-widest px-1">Complaint Category</label>
              <select 
                className="w-full bg-white border border-slate-100 rounded-2xl px-6 py-5 text-sm font-black text-brand-primary outline-none focus:ring-4 focus:ring-indigo-600/10 transition-all shadow-sm"
                value={category}
            ...
            <div className="space-y-4">
              <label className="text-[10px] font-black text-brand-primary/40 uppercase tracking-widest px-1">Statement of Facts</label>
              <textarea 
                placeholder="Describe the incident, providing as much detail as possible for the audit team..."
                className="w-full h-48 bg-white border border-slate-100 rounded-[32px] px-8 py-6 text-sm font-medium text-brand-ink outline-none focus:ring-4 focus:ring-indigo-600/10 transition-all shadow-sm resize-none"
                value={description}
          ...
          <div className="pt-6 relative z-10">
            <button 
              type="submit" 
              disabled={submitting}
              className="w-full py-6 bg-brand-primary text-white rounded-[30px] font-black text-[12px] uppercase tracking-widest shadow-2xl shadow-brand-primary/20 hover:bg-brand-primary active:scale-95 transition-all flex items-center justify-center gap-4"
            >
