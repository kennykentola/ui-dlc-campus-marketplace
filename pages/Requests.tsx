...
const Requests: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-40 animate-fadeIn relative text-brand-ink dark:text-slate-100">
             ...
             requests.map((r, i) => (
                <div key={i} className={`p-10 border border-slate-100 dark:border-slate-800 rounded-[48px] space-y-8 hover:shadow-2xl hover:border-brand-primary/10 transition-all group ${r.isFulfilled ? 'opacity-50 grayscale' : 'bg-white dark:bg-slate-900 shadow-sm'}`}>
                   ...
                   <div className="pt-6 border-t border-slate-50 dark:border-slate-800 flex items-center justify-between">
                      ...
                      <button className="w-12 h-12 bg-slate-50 dark:bg-slate-800 rounded-2xl flex items-center justify-center text-brand-primary dark:text-indigo-500 group-hover:bg-brand-primary group-hover:text-white transition-all shadow-sm">
